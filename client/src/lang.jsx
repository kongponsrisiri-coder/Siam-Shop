...
const STRINGS = {
  en: {
    ...
    minOrderDelivery: 'Minimum order for delivery',
    orCollect: 'or choose collection at checkout',
    addMore: 'Add',
    ...
    available: 'Available',
    notNow: 'Not available right now',
    closedNow: 'Not accepting orders right now',
    opens: 'we open',
    collectionOk: 'Scheduled collection orders are still welcome',
    deliveryOpt: 'Delivery',
    collectionOpt: 'Collection',
  ...
  th: {
    ...
    minOrderDelivery: 'ยอดสั่งซื้อขั้นต่ำสำหรับจัดส่ง',
    orCollect: 'หรือเลือกมารับเองตอนชำระเงิน',
    addMore: 'เพิ่มอีก',
    ...
    available: 'มีจำหน่าย',
    notNow: 'ยังไม่เปิดขายในเวลานี้',
    closedNow: 'ร้านยังไม่รับออเดอร์ในขณะนี้',
    opens: 'เปิด',
    collectionOk: 'ยังสั่งล่วงหน้าเพื่อมารับที่ร้านได้',
    deliveryOpt: 'จัดส่ง',
    collectionOpt: 'รับที่ร้าน',
    pickupTime: 'เวลารับสินค้า',
    collectFrom: 'รับสินค้าที่',
  },
};
